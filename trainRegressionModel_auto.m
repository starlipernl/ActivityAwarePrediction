function [trainedModel, validationRMSE] = trainRegressionModel_auto(trainingData)
...
% Auto-generated by MATLAB on 16-Mar-2018 03:56:56
...
for i = 1:size(trainingData,2)
    tableCols{i} = ['column_' num2str(i)];
    isCategoricalPredictor(:,i) = false;
end
    
inputTable = array2table(trainingData, 'VariableNames', tableCols);
responseCol = tableCols{end};
predictorNames = tableCols(:,1:end-1);
predictors = inputTable(:, predictorNames);
response = inputTable{:,responseCol};
